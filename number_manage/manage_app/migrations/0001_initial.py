# Generated by Django 4.2.2 on 2023-06-21 04:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_full_name', models.CharField(max_length=80, null=True, verbose_name='全名/备注')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='下号时间')),
                ('inbound', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='manage_app.customer', verbose_name='呼入客户')),
                ('supplier', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='manage_app.supplier', verbose_name='供应商')),
            ],
            options={
                'verbose_name': '固话号码',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('business', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='manage_app.business', verbose_name='客户-业务')),
                ('numbers', manage_app.models.CustomLandlineNumberField(to='manage_app.landlinenumber', verbose_name='固话号码')),
            ],
            options={
                'verbose_name': '固话号码分配',
